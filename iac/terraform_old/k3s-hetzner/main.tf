module "kube-hetzner" {
  ...
  ssh_public_key  = file(".ssh/kube_hetzner_key.pub")
  ssh_private_key = file(".ssh/kube_hetzner_key")
  ...
  additional_tls_sans       = ["api.k8s0.ujstor.com"]
  kubeconfig_server_address = "api.k8s0.ujstor.com"
